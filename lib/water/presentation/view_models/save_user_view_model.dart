...
class SaveUserViewModelImp implements SaveUserViewModel {
  ...
  Future<Result<void>> updateUser(UserEntity userEntity) async {
    ...
    var dailyDrinkingGoal = calculateDailyDrinkingGoal as double;

    var updateDailyDrinkingGoal = await _userRepository.updateDailyDrinkingGoal(dailyDrinkingGoal.toInt());
