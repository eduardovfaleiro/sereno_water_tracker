...
import '../../../layers/presentation/controllers/water_starter_controller.dart';
import '../../../layers/presentation/pages/water_starter_page/water_starter_model.dart';
import '../../core.dart';
...
Future<void> initApp() async {
  ...
  initGetIt([
    RegisterLazySingletonImp<HiveInterface>(
      () => Hive,
    ),
    ...
    RegisterLazySingletonImp<WaterStarterModel>(
      () => WaterStarterModelImp(),
    ),
    RegisterLazySingletonImp<WaterDisplayController>(
      () => WaterDisplayController(GetIt.I(), GetIt.I(), GetIt.I()),
    ),
    RegisterLazySingletonImp<WaterStarterController>(
      () => WaterStarterController(GetIt.I()),
    ),
  ]);
