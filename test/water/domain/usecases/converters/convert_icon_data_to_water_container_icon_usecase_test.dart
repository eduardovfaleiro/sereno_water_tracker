...
void main() {
  var useCase = ConvertIconDataToWaterContainerIconUseCaseImp();
  ...
  test('Should return the correct IconData when icon is mapped', () async {
    ...
    var result = useCase(icon);

    expect(result, waterContainerIcon);
  });

  test('Should throw IconNotFoundException', () async {
    var icon = Icons.abc;

    expect(() => useCase(icon), throwsA(const TypeMatcher<IconNotFoundException>()));
  });
}
